...
- **Subtitle source:** `C:\Users\warit\AppData\Local\hermes\attachments\Subtitle 1.srt` (SRT file matching Resolve timeline)
- **SFX track:** Track 2 (SFX 1) — the only available SFX track
