...
`KEYWORD_PATTERNS` in `davinci-resolve-mcp/src/sfx_engine/analyzer.py` — 7 patterns with Thai+English regex:
...
See also: [[analysis-pipeline]], [[event-taxonomy]], [[negative-knowledge]]
